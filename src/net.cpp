...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PumpGroupCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    	{"seednode1.pumpgroupcoin.com", "seednode1.pumpgroupcoin.com"},	
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("PumpGroupCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PumpGroupCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("PumpGroupCoin-start");
